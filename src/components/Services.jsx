    ...
    <section className="relative min-h-screen overflow-hidden bg-white">
      ...
      <div className="services-angled-block" aria-hidden="true">
        <div className="services-angled-inner">
          ...
          <div className="text-3xl font-extrabold leading-tight text-white md:text-5xl">HOME OF</div>
          <div className="text-4xl font-extrabold leading-none text-white md:text-6xl">CREATIVITY</div>
        </div>
      </div>
      ...
      <div className="container relative z-10 px-6 py-16 mx-auto">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-10 md:mb-14">
            <div className="inline-block px-6 py-3 text-2xl font-extrabold text-white heading-bubble md:text-3xl">Our Services</div>
          </div>
