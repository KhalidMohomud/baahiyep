...
const SectionFooter = () => {
  return (
    <footer className="bg-gradient-to-br from-brandNavy via-[#1a1a2e] to-brandNavy dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white transition-colors duration-300">
      {/* Main Content */}
