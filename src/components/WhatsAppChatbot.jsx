...
const WhatsAppChatbot = () => {
  ...
  const botResponses = {
    ...
    'help': "I'm here to help! You can ask me about our services, pricing, or any other questions you might have.",
    'services': "We offer web design, development, digital marketing, and more! Would you like to know more about any specific service?",
    ...
    <>
      ...
      <div className="fixed z-50 bottom-6 right-6">
        <button
          ...
          className="p-4 text-white transition-all duration-300 transform bg-green-500 rounded-full shadow-lg hover:bg-green-600 hover:shadow-xl hover:scale-110"
      ...
      {/* Chat Interface */}
      {isOpen && (
        <div className="fixed z-40 flex flex-col bg-white border border-gray-200 rounded-lg shadow-2xl bottom-24 right-6 w-80 h-96">
          {/* Chat Header */}
          <div className="flex items-center justify-between p-4 text-white bg-green-500 rounded-t-lg">
          ...
          <div className="flex-1 p-4 space-y-3 overflow-y-auto">
            ...
            {isTyping && (
              <div className="flex justify-start">
                <div className="px-3 py-2 text-gray-800 bg-gray-100 rounded-lg">
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 text-white transition-colors bg-green-500 rounded-lg hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="flex items-center justify-center w-full px-4 py-2 mt-3 text-white transition-colors bg-green-600 rounded-lg hover:bg-green-700"
            >
