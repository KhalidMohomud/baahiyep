...
const EventBrandingPackages = () => {
  ...
  return (
    <section className="relative py-20 transition-colors duration-300 bg-gradient-to-b from-white via-gray-50 to-white dark:from-dark-bg dark:via-dark-surface dark:to-dark-bg">
